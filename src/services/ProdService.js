...
const getByIdProdPriceService = async(req) =>{
    const {id} = req.params;
    const prodById = await ProdModel.findById(id);
    ...
    return {price : prodById.price * response.data.blue};
}

module.exports = {addProdService, getAllProdService,getByIdProdService,updateProdService,deleteProdService,getByIdProdPriceService}